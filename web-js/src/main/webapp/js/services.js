...
var eventjugglerServices = angular.module('eventjugglerServices',
		[ 'ngResource' ]);
...
eventjugglerServices.service('User', function($resource, $http, $cookieStore) {
	...
	if (!user.loggedIn && sessionStorage.getItem("auth-token")) {
		$http.defaults.headers.common['Auth-Token'] = sessionStorage
				.getItem("auth-token");
...
eventjugglerServices.service('Event', function($resource, User, $http,
